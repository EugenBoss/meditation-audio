...
- pause_after_ms: între 1500 și 10000
- emphasis_words: max 2-3 per segment
- has_name: true dacă segmentul conține prenumele utilizatorului
- Pauzele cresc: preparare (2000-3000) → inducție (3000-4000) → deepening (4000-6000) → sugestii (3000-5000)
- La reorientare, pauzele scad
- Pauze de integrare (8000-12000) după sugestii puternice
- Pauze de respirație (5000-7000) marcate cu "Respiră adânc..."
...
- pause_after_ms: between 1500 and 10000
- emphasis_words: max 2-3 per segment
- has_name: true if segment contains user's name
- Pauses increase: preparation (2000-3000) → induction (3000-4000) → deepening (4000-6000) → suggestions (3000-5000)
- Reorientation: pauses decrease
- Integration pauses (8000-12000) after powerful suggestions
- Breathing pauses (5000-7000) with "Take a deep breath..."
